...
main(int argc, char* argv[])
{
  ...
  // std::string traceRoutePrefixOnProducer = traceRoutePrefix + prefix;
  ndn::AppHelper consumerHelper("ns3::ndn::BoltConsumerCbr");
  ...
  // Snake bolt
  ndn::AppHelper appHelper("ns3::ndn::BoltApp");
