...
main(int argc, char* argv[])
{
  ...
  computation.Install(grid.GetNode(0,0));
  computation.Install(grid.GetNode(0,1));
  computation.Install(grid.GetNode(0,2));
  computation.Install(grid.GetNode(1,0));
  computation.Install(grid.GetNode(1,1));
  computation.Install(grid.GetNode(1,2));
  computation.Install(grid.GetNode(2,0));
  computation.Install(grid.GetNode(2,1));
  computation.Install(grid.GetNode(2,2));
